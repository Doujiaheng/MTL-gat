...
//    l_filter_rank /= testTotal;
    l_filter_rank = l_filter_rank * 2 / testTotal;
    r_filter_rank /= testTotal;

//    l_filter_reci_rank /= testTotal;
    l_filter_reci_rank = l_filter_reci_rank * 2/testTotal;
    r_filter_reci_rank /= testTotal;
 
//    l_filter_tot /= testTotal;
//    l3_filter_tot /= testTotal;
//    l1_filter_tot /= testTotal;
    l_filter_tot = l_filter_tot * 2 / testTotal;
    l3_filter_tot = l3_filter_tot * 2 / testTotal;
    l1_filter_tot = l1_filter_tot * 2 /testTotal;
...
//    printf("\n");
    ...
    printf("averaged(filter):\t %f \t %f \t %f \t %f \t %f \n",
            (l_filter_reci_rank+2 * r_filter_reci_rank)/3, (l_filter_rank+2 * r_filter_rank)/3, (l_filter_tot+2 * r_filter_tot)/3, (l3_filter_tot+2 * r3_filter_tot)/3, (l1_filter_tot+2 * r1_filter_tot)/3);

    mrr = (l_filter_reci_rank+r_filter_reci_rank) / 2;
    mr = (l_filter_rank+r_filter_rank) / 2;
    hit10 = (l_filter_tot+2 * r_filter_tot) / 3;
...
//        r1_filter_tot_constrain /= testTotal;
        ...
        l_filter_rank_constrain = l_filter_rank_constrain * 2 / testTotal;
        r_filter_rank_constrain /= testTotal;

        l_filter_reci_rank_constrain = l_filter_reci_rank_constrain * 2/testTotal;
        r_filter_reci_rank_constrain /= testTotal;


        l_filter_tot_constrain = l_filter_tot_constrain * 2 / testTotal;
        l3_filter_tot_constrain = l3_filter_tot_constrain * 2 / testTotal;
        l1_filter_tot_constrain = l1_filter_tot_constrain * 2 /testTotal;
        ...
        printf("averaged(filter):\t %f \t %f \t %f \t %f \t %f \n",
                (l_filter_reci_rank_constrain+2 * r_filter_reci_rank_constrain)/3, (l_filter_rank_constrain+2 * r_filter_rank_constrain)/3, (l_filter_tot_constrain+ 2 * r_filter_tot_constrain)/3, (l3_filter_tot_constrain+2 * r3_filter_tot_constrain)/3, (l1_filter_tot_constrain+2 * r1_filter_tot_constrain)/3);

        mrrTC = (l_filter_reci_rank_constrain+2 * r_filter_reci_rank_constrain)/3;
        mrTC = (l_filter_rank_constrain+2 * r_filter_rank_constrain) / 3;
        hit10TC = (l_filter_tot_constrain+2 * r_filter_tot_constrain) / 3;
        hit3TC = (l3_filter_tot_constrain+2 * r3_filter_tot_constrain) / 3;
        hit1TC = (l1_filter_tot_constrain+2 * r1_filter_tot_constrain) / 3;
    }
