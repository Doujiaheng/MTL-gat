...
class TrainDataLoader(object):
    ...
    def __init__(self,
        ...
        base_file = os.path.abspath(os.path.join(os.path.dirname(__file__), bfile))
    ...
    def read(self):
        ...
        if self.nbatches == None:
            ...
            print('nbatchs is :', self.nbatches)
...
class TestDataLoader(object):
    ...
    def __init__(self, in_path = "./", sampling_mode = 'link', base_add='Base1.so', type_constrain = True):
        base_file = os.path.abspath(os.path.join(os.path.dirname(__file__), "./release/", base_add))
        self.lib = ctypes.cdll.LoadLibrary(base_file)
        """for link prediction"""
